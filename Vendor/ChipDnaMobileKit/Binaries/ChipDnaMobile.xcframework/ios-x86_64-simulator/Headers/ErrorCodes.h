...
extern NSString * const AutoConfirmRequired;       /**< Auto confirm is required. */
extern NSString * const TransactionPOIInvalid;     /**< Invalid transaction point of interaction parameter value. */
 ...
 */
extern NSString * const ApplicationUpdateRequired;                 /**< The current version of the ChipDna Mobile software is invalid and an update is required. */
extern NSString * const IdTechBundleRequired;                      /**< The IDTech.Bundle is missing and is required to be added to the application.*/
...
extern NSString * const MerchantTippingNotSupported;               /**< Merchant Tipping is not supported */
...
extern NSString * const TransactionPOINotConnected;                 /**< The transaction point of interaction attempting to be used is not connected*/
...
extern NSString * const FirmwareUpdateRequired;                     /**< A firmware update has breached its expiration and must be applied before transaction processing can continue.  */
...
extern NSString * const AccountVerificationAmountFormatError;                /**< There is a format error with the Account Verification Amount. */
...
extern NSString * const TerminalProfileIdentifierFormatError;                /**< There is a format error with the TerminalProfileIdentifier. */
extern NSString * const JwtAuthenticationUrlFormatError;                     /**< There is a format error with the JwtAuthenticationUrl. */
extern NSString * const JwtExpiryTimeFormatError;                            /**< There is a format error with the JwtExpiryTime. */
extern NSString * const JwtExpiryPaddingFormatError;                         /**< There is a format error with the JwtExpiryPadding. */
extern NSString * const TapToMobileServerUrlFormatError;                     /**< There is a format error with the TapToMobileServerUrl. */
extern NSString * const TerminalCountryAlphaCodesFormatError;                /**< There is a format error with the TerminalCountryAlphaCodes. */
...
extern NSString * const FirmwareUpdateConfigurationFormatError;              /**< There is a format error with FirmwareUpdateConfiguration*/
extern NSString * const ConnectionParametersFormatError;                     /**< There is a format error with ConnectionParameters*/
extern NSString * const DefaultAmountsFormatError;                           /**< There is a format error with DefaultAmounts*/
...
extern NSString * const TapToMobileSupportedFormatError;                     /**< There is a format error with TapToMobileSupported*/
/**
 * @}
 */
...
extern NSString * const TipAmountInvalid;                           /**< The tip amount is invalid. */
...
extern NSString * const AllowlistedCardPresented;                   /**< The transaction cannot continue because the presented card is an allowlisted non-payment card. */
...
extern NSString * const ClientIDMissing;                            /**< The Client ID is missing. */
extern NSString * const ClientSecretMissing;                        /**< The Client secret is missing. */
...
extern NSString * const TapToMobileSessionClosed;                   /**< The Reader Session for TapToMobile is closed. */
...
extern NSString * const TapToMobileTransactionTerminated;           /**< (Terminal) Transaction Terminated. */
...
extern NSString * const TipAmountNotAllowed;                        /**< Tip amount is not allowed for this transaction. */
...
extern NSString * const ApplicationIdInvalid;                       /**< The application identifier is invalid. */
...
extern NSString * const NoPoiSelected;                              /**< No point of interaction selected for configuration. */
extern NSString * const TapToMobileNotSupported;                    /**< The current hardware does not support Tap To Mobile payment processing. */
extern NSString * const InvalidAppleAccount;                        /**< Indicates an invalid, non-empty reader token associated with the current Apple account. */
extern NSString * const LocationPermissionsNotGranted;              /**< The current application does have location permissions granted to allow Tap To Mobile payment processing. */
extern NSString * const CountryCodeInvalid;                         /**< There is an error with the country code being used for Tap To Mobile. */
extern NSString * const AttestationFailed;                          /**< The attestation process for Tap To Mobile has failed. */
extern NSString * const AccessTokenExpired;                         /**< The the token for authenticating Tap To Mobile transactions has expired. */
extern NSString * const MissingTeamIdentifier;                      /**< The team identifier could not be found.*/
extern NSString * const MissingBundleIdentifier;                    /**< The bundle identifier could not be found.*/
extern NSString * const CurrentCountryNotAllowed;                   /**< Merchant/Partner is not allowed to operate in the current country.*/
extern NSString * const NoLocationFound;                            /**< The current device could not be located.*/
/**
 * @}
 */
