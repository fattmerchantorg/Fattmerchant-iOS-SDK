...
/**
 * Serialize {@link FirmwareUpdateStatus} object into XML representation.
 *
 * @param firmwareUpdateStatus FirmwareUpdateStatus object to be serialized.
 * @return XML respresentation of firmware update status.
 */
+(NSString *)serializeFirmwareUpdateStatus:(FirmwareUpdateStatus *)firmwareUpdateStatus;

/**
 * Deserialize XML representation of {@link FirmwareUpdateStatus} into an object.
 *
 * @param firmwareUpdateStatus xml representation of {@link FirmwareUpdateStatus}.
 * @return {@link FirmwareUpdateStatus} object.
 */
