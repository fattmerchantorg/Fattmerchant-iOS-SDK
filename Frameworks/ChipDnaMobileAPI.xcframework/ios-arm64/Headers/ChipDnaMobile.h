 ...
 * @class ChipDnaMobile
 * @copyright Copyright Creditcall Limited 2010 - 2025.
 ...
 * <ul>
 * <li>BBPOS Chipper CHB20, CHB22, CHB29 or CHB30</li>
 * <li>Datecs Bluepad50 Contact or Contactless</li>
 * <li>Miura M020 or M021</li>
 * <li>IDTech VP3350</li>
 * </ul>
 ...
 * <p>{@link CCParameters#CCParamTerminalId CCParamTerminalId} Set the terminal ID.</p>
 * <p>{@link CCParameters#CCParamTransactionKey CCParamTransactionKey} Set the transaction key.</p>
 * <p>{@link CCParameters#CCParamApiKey CCParamApiKey} Set the API Key for the Gateway.</p>
 * <p>{@link CCParameters#CCParamApplicationIdentifier CCParamApplicationIdentifier} Set the Application Identifier.</p>
 ...
 * <p>{@link CCParameters#CCParamPinPadConnectionType CCParamPinPadConnectionType} Set the connection type of the PIN pad. Valid values are {@link CCParameters#CCValueBluetooth CCValueBluetooth}, {@link CCParameters#CCValueBLE CCValueBLE}, {@link CCParameters#CCValueTcpIp CCValueTcpIp} and {@link CCParameters#CCValueLightningUsb CCValueLightningUsb}.</p>
 * <p>{@link CCParameters#CCParamPinPadIpAddress CCParamPinPadIpAddress} Set the PIN pad IP address for a  {@link CCParameters#CCValueTcpIp CCValueTcpIp} connection type.</p>
 * <p>{@link CCParameters#CCParamPinPadIpAddress CCParamPinPadPort} Set the PIN pad port for a  {@link CCParameters#CCValueTcpIp CCValueTcpIp} connection type.</p>
 * <p>{@link CCParameters#CCParamWebMisUsername CCParamWebMisUsername} Set WebMIS username for test environment.</p>
 * <p>{@link CCParameters#CCParamWebMisPassword CCParamWebMisPassword} Set WebMIS password for test environment.</p>
 * @return parameter collection containing {@link CCParameters#CCParamResult CCParamResult} and if applicable {@link CCParameters#CCParamErrors CCParamErrors}.
 */
 ...
 *
 * @param request Parameter collection which can contain the following:
 * <p>{@link CCParameters#CCParamFullTmsUpdate CCParamFullTmsUpdate} Forces a full TMS update. All configuration for the currently connected PIN pad is downloaded regardless of whether it's required. </p>
 * <p>{@link CCParameters#CCParamApplyFirmwareUpdate}  (Only supported on VP3350) When present with the value ParameterValues.FALSE, this stops a firmware update beginning, if one is available. </p>
 *
 * @return parameter collection containing {@link CCParameters#CCParamResult CCParamResult} and if applicable {@link CCParameters#CCParamErrors CCParamErrors}.
 **/
...
/**
 * Connect to and configure the current device. This method will perform all necessary actions required to get the selected PIN pad and or Tap To Mobile ready for transactions.
 ...
 * <p>{@link CCParameters#CCValueVerifyingPinPad CCValueVerifyingPinPad}</p>
 * <p>{@link CCParameters#CCValueRegistering CCValueRegistering}</p>
 ...
 * <p>{@link CCParameters#CCValueUpdatingTapToMobileConfig CCValueUpdatingTapToMobileConfig}</p>
 * <p>{@link CCParameters#CCValueUpdatingPinPadFirmware CCValueUpdatingPinPadFirmware}</p>
 * <p>{@link CCParameters#CCValueUpdatingPinPadFirmwareConfig CCValueUpdatingPinPadFirmwareConfig}</p>
 * <p>{@link CCParameters#CCValueRebootingPinPad CCValueRebootingPinPad}</p>
 * <p>{@link CCParameters#CCValueUpdatingSecurityConfig CCValueUpdatingSecurityConfig}</p>
 *
 *
 * The observer can recive {@link CCParameters#CCParamTapToMobileConfigurationPercentage CCParamTapToMobileConfigurationPercentage}, showing the progress of the Tap To Mobile configuration process. This will be received after a {@link CCParameters#CCParamConfigurationUpdate CCParamConfigurationUpdate} with the value of {@link CCParameters#CCValueUpdatingTapToMobileConfig CCValueUpdatingTapToMobileConfig}.</p>
 *
 ...
 * <p>{@link CCParameters#CCParamBLEScanTime CCParamBLEScanTime}  (Optional) Set the length of time Bluetooth Low Energy (BLE) devices will be scanned for. The value is required to be a string valued number between 1 and 30. The default value of 15 seconds will be used if this value is not available. </p>
 * <p>{@link CCParameters#CCParamApplyFirmwareUpdate}  (Optional)  (Only supported on VP3350)  When present with the value {@link CCParameters#CCValueFalse FALSE} , this stops a firmware update beginning, if one is available. </p>
 * <p>{@link CCParameters#CCParamPaymentDevicePOI}  (Optional) Sets if the Payment Device point of interaction is to be configured for payment processing. Values can be {@link CCParameters#CCValueTrue TRUE} or {@link CCParameters#CCValueFalse FALSE}.  (Defaults to {@link CCParameters#CCValueTrue TRUE} if the parameter key is not present). </p>
 * <p>{@link CCParameters#CCParamTapToMobilePOI}  (Optional) Sets if the Tap To Mobile point of interaction is to be configured for payment processing. Values can be {@link CCParameters#CCValueTrue TRUE} or {@link CCParameters#CCValueFalse FALSE}.  (Defaults to {@link CCParameters#CCValueFalse FALSE} if the parameter key is not present). </p>
 *
 * @return parameter collection containing {@link CCParameters#CCParamResult CCParamResult} and if applicable {@link CCParameters#CCParamErrors CCParamErrors}.
 */
...
/**
 * @brief Checks the current status of various components of ChipDNA Mobile in a single call.
 *
 * Parameters returned can be filtered by passing in the {@link CCParameters} with a value of {@link CCParameters#CCValueTrue TRUE}.
 * Only {@link CCParameters} listed in the possible return parameters can be filtered for.
 * If one or more valid {@link CCParameters} with a value of {@link CCParameters#CCValueTrue TRUE}  is passed into the request, filtering is enabled,
 * and only the filtered {@link CCParameters} will be returned if available.
 *
 * If no {@link CCParameters} are passed into the request or just {@link CCParameters#CCParamPaymentPlatformTest CCParamPaymentPlatformTest},
 * then all available {@link CCParameters} are returned in the response.
 *
 * @param request Parameter collection which can contain the following:
 * <ul>
 *   <li>{@link CCParameters#CCParamPaymentPlatformTest CCParamPaymentPlatformTest} with a value of {@link CCParameters#CCValueTrue TRUE} to check the status of the payment platform, returning the result in a {@link PaymentPlatformStatus} object in the response. Sending this parameter does not enable filtering as it not returned as default.</li>
 *   <li>Any {@link CCParameters} with a value of {@link CCParameters#CCValueTrue TRUE} listed in the possible return parameters. (Except {@link CCParameters#CCParamResult CCParamResult} and {@link CCParameters#CCParamPaymentPlatformStatus CCParamPaymentPlatformStatus})</li>
 * </ul>
 *
 * @return Parameter collection which can contain the following:
 * <ul>
 *   <li>{@link CCParameters#CCParamResult CCParamResult} - Defines if the call to getStatus was successful using the values {@link CCParameters#CCValueTrue TRUE} and {@link CCParameters#CCValueFalse FALSE}.</li>
 *   <li>{@link CCParameters#CCParamVersionInformation CCParamVersionInformation} - An XML representation of a {@link VersionInformation} object. {@link ChipDnaMobileSerializer#deserializeVersionInformation: deserializeVersionInformation} can be used to retrieve the object.</li>
 *   <li>{@link CCParameters#CCParamChipDnaStatus CCParamChipDnaStatus} - A string representing the current status of ChipDNA Mobile.</li>
 *   <li>{@link CCParameters#CCParamDeviceStatus CCParamDeviceStatus} - An XML representation of a {@link DeviceStatus} object. {@link ChipDnaMobileSerializer#deserializeDeviceStatus: deserializeDeviceStatus} can be used to retrieve the object.</li>
 *   <li>{@link CCParameters#CCParamTmsStatus CCParamTmsStatus} - An XML representation of a {@link TmsStatus} object. {@link ChipDnaMobileSerializer#deserializeTmsStatus: deserializeTmsStatus} can be used to retrieve the object.</li>
 *   <li>{@link CCParameters#CCParamTerminalStatus CCParamTerminalStatus} - An XML representation of the {@link TerminalStatus}. {@link ChipDnaMobileSerializer#deserializeTerminalStatus: deserializeTerminalStatus} can be used to retrieve the object.</li>
 *   <li>{@link CCParameters#CCParamEnvironment CCParamEnvironment} - The current environment ChipDnaMobile is running in. Possible values are {@link CCParameters#CCValueEnvironmentLive CCValueEnvironmentLive} or {@link CCParameters#CCValueEnvironmentTest CCValueEnvironmentTest}.</li>
 *   <li>{@link CCParameters#CCParamRequestQueueStatus CCParamRequestQueueStatus} - An XML representation of a {@link RequestQueueStatus} object. {@link ChipDnaMobileSerializer#deserializeRequestQueueStatus: deserializeRequestQueueStatus} can be used to retrieve the object.</li>
 *   <li>{@link CCParameters#CCParamPaymentPlatformStatus CCParamPaymentPlatformStatus} - An XML representation of a {@link PaymentPlatformStatus} object. {@link ChipDnaMobileSerializer#deserializePaymentPlatformStatus: deserializePaymentPlatformStatus} can be used to retrieve the object.</li>
 *   <li>{@link CCParameters#CCParamLinkedRefundSupported CCParamLinkedRefundSupported} - Indicates that linked refunds are supported with the currently configured terminal if present with the value {@link CCParameters#CCValueTrue TRUE}.</li>
 *   <li>{@link CCParameters#CCParamStandaloneRefundsSupported CCParamStandaloneRefundsSupported} - Indicates that standalone refunds are supported with the currently configured terminal if present with the value {@link CCParameters#CCValueTrue TRUE} .</li>
 *   <li>{@link CCParameters#CCParamCashTransactionsSupported CCParamCashTransactionsSupported} - Indicates that cash transactions are supported with the currently configured terminal if present with the value {@link CCParameters#CCValueTrue TRUE}.</li>
 *   <li>{@link CCParameters#CCParamChequeTransactionsSupported CCParamChequeTransactionsSupported} - Indicates that cheque transactions are supported with the currently configured terminal if present with the value {@link CCParameters#CCValueTrue TRUE}.</li>
 *   <li>{@link CCParameters#CCParamTransactionHistorySupported CCParamTransactionHistorySupported} - Indicates that transaction history is supported with the currently configured terminal if present with the value {@link CCParameters#CCValueTrue TRUE}.</li>
 *   <li>{@link CCParameters#CCParamEmailReceiptSupported CCParamEmailReceiptSupported} - Indicates that centralized email receipting is supported with the currently configured terminal if present with the value {@link CCParameters#CCValueTrue TRUE}.</li>
 *   <li>{@link CCParameters#CCParamSmsReceiptSupported CCParamSmsReceiptSupported} - Indicates that centralized SMS receipting is supported with the currently configured terminal if present with the value {@link CCParameters#CCValueTrue TRUE}.</li>
 *   <li>{@link CCParameters#CCParamRefundOperatorPinSupported CCParamRefundOperatorPinSupported} - Indicates that an operator PIN must be supplied to perform standalone refunds with the currently configured terminal if present with the value {@link CCParameters#CCValueTrue TRUE}.</li>
 *   <li>{@link CCParameters#CCParamTippingSupported CCParamTippingSupported} - If present, indicates the type of tipping supported with the currently configured terminal. Possible values are {@link CCParameters#CCValueEndOfDayTipping CCValueEndOfDayTipping }, {@link CCParameters#CCValueOnDeviceTipping CCValueOnDeviceTipping}, or {@link CCParameters#CCValueBothTipping CCValueBothTipping}.</li>
 *   <li>{@link CCParameters#CCParamApplicationIdentifier CCParamApplicationIdentifier} - A string representing the current identifier for the application.</li>
 *   <li>{@link CCParameters#CCParamMerchantDisplayName CCParamMerchantDisplayName} - Indicates the currently configured merchant display name, if present.</li>
 *   <li>{@link CCParameters#CCParamPinPadName CCParamPinPadName} - Indicates the currently configured PINpad name, if present.</li>
 *   <li>{@link CCParameters#CCParamPinPadConnectionType CCParamPinPadConnectionType} - Indicates the currently configured PINpad connection type, if present.</li>
 *   <li>{@link CCParameters#CCParamPinPadIpAddress CCParamPinPadIpAddress} - Indicates the currently configured PINpad IP address, if present.</li>
 *   <li>{@link CCParameters#CCParamPinPadPort CCParamPinPadPort} - Indicates the currently configured PINpad port, if present.</li>
 *   <li>{@link CCParameters#CCParamFirmwareUpdateAvailable CCParamFirmwareUpdateAvailable} - Indicates if a firmware update is available for the currently configured PINpad.</li>
 *   <li>{@link CCParameters#CCParamFirmwareUpdateStatus CCParamFirmwareUpdateStatus} -  An XML representation of a {@link FirmwareUpdateStatus} object. {@link ChipDnaMobileSerializer#deserializeFirmwareUpdateStatus: deserializeFirmwareUpdateStatus} can be used to retrieve the object.</li>
 *   <li>{@link CCParameters#CCParamPOSGUID CCParamPOSGUID} - A string representing the current point of sale globally unique identifier.</li>
 *   <li>{@link CCParameters#CCParamTapToMobilePOIIdentifier CCParamTapToMobilePOIIdentifier} - A string representing the current TTM point of interaction identifier.</li>
 * </ul>
 */
 ...
 * <li>{@link ChipDnaMobile#addUserNotificationTarget:action: UserNotification} - recommended for BBPOS Chipper 2X BT, BBPOS Chipper 3X BT and ID TECH VP3350</li>
 * <li>{@link ChipDnaMobile#addCardApplicationSelectionTarget:action: CardApplicationSelection} - required for BBPOS Chipper 2X BT, BBPOS Chipper 3X BT and ID TECH VP3350</li>
 * </ul>
 *
 ...
 * <p>{@link CCParameters#CCParamTipAmount CCParamTipAmount} The tip amount to be used in the transaction (Merchant Tipping). This tip amount is added to the transaction amount. Only supported on Tap To Mobile. </p>
 ...
 * </p>{@link CCParameters#CCParamTransactionPOI CCParamTransactionPOI} (Optional) Sets the point of interaction to be used for this transaction. If one POI has been configured via ChipDnaMobile.connectAndConfigure, then this will be the default value, if one is not present. If multiple POI have been configured, then the default value will be ParameterValues.PaymentDevice, if the parameter key is not present. Values can be {@link CCParameters#CCValuePaymentDevice CCValuePaymentDevice} or {@link CCParameters#CCValueTapToMobile CCValueTapToMobile}
 *
 * @return parameter collection containing {@link CCParameters#CCParamResult CCParamResult} and if applicable {@link CCParameters#CCParamErrors CCParamErrors}.
 */
 ...
 * <p>{@link CCParameters#CCParamResult CCParamFirmwareUpdateAvailable} defining if a firmware update is available using the values {@link CCParameters#CCValueTrue TRUE} and {@link CCParameters#CCValuesFalse FALSE}.</p>
 * <p>{@link @CCParameters#CCParamDeviceStatusUpdate CCParamFirmwareUpdateStatus} returned with a serialized {@link FirmwareUpdateStatus} object. {@link FirmwareUpdateStatus } can be deserialized using {@link ChipDnaMobileSerializer#deserializeFirmwareUpdateStatus:}.</p>
 *
 ...
 * <p>{@link CCParameters#CCParamResult CCParamFirmwareUpdateAvailable} defining if a firmware update is available using the values {@link CCParameters#CCValueTrue TRUE} and {@link CCParameters#CCValuesFalse FALSE}.</p>
 * <p>{@CCParameters#CCParamDeviceStatusUpdate CCParamFirmwareUpdateStatus} returned with a serialized {@link FirmwareUpdateStatus} object. {@link FirmwareUpdateStatus } can be deserialized using {@link ChipDnaMobileSerializer#deserializeFirmwareUpdateStatus:}.</p>
 ...
 * <p>{@CCParameters#CCParamTapToMobileConfigurationPercentage CCParamTapToMobileConfigurationPercentage} showing the progress of the Tap To Mobile configuration process.
 *
...
/**
 * Add an observer and action to get the event for firmware updates. Set observer before calling method {@link ChipDnaMobile#connectAndConfigure: connectAndConfigure}.
 *
 * Currently events for firmware updates are only supported by IDTech VP3350, Miura M020 and Miura M021 PIN pads.
 *
 * Observers are returned a {@link CCParameters} collection which can contain:
 *  <p>{@link CCParameters#CCParamFirmwareUpdateAvailable CCParamFirmwareUpdateAvailable} When present with the value {@link CCParameters#CCValueTrue TRUE}, indicates that a firmware update is available for the currently configured terminal.</p>
 *  <p>{@link CCParameters#CCParamFirmwareUpdateStatus CCParamFirmwareUpdateStatus} - An XML representation of a {@link FirmwareUpdateStatus} object. {@link ChipDnaMobileSerializer#deserializeFirmwareUpdateStatus:} can be used to retrieve an object.</p>
 *  <p>{@link CCParameters#CCParamFirmwareDownloadPercentage CCParamFirmwareDownloadPercentage} A value from 0 to 100 which shows the percentage of the firmware downloaded to the PIN pad.</p>
 *  <p>{@link CCParameters#CCParamFirmwareFile CCParamFirmwareFile} The name of the file being downloaded to the PIN pad.</p>
 *  <p>{@link CCParameters#CCParamFirmwareUpdate CCParamFirmwareUpdate} A {@link FirmwareUpdate} providing an update on the firmware update process.</p>
 *
 * When updates are no longer required by the observer a call should be made to {@link ChipDnaMobile#removeFirmwareUpdateTarget:}.
 *
 * @param target Target wishing to know when a firmware update is required or updates about an in progress firmware update.
 * @param action Action to be called on observing target.
 */
+(void)addFirmwareUpdateTarget:(id)target action:(SEL)action;
