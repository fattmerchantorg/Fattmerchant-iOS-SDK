...
extern CCParameterValue const CCValueUpdatingTapToMobileConfig; /**< @memberof CCParameters Parameter value indicating that {@link ChipDnaMobile#connectAndConfigure:} is updating the configuration for Tap To Mobile. */
extern CCParameterValue const CCValueCheckingTapToMobileConfig; /**< @memberof CCParameters Parameter value indicating that {@link ChipDnaMobile#connectAndConfigure:} is checking the configuration of Tap To Mobile.*/
...
extern CCParameterValue const CCValuePaymentDevice; /**< @memberof CCParameters Parameter value indicating a transaction is to be performed via a payment device POI. */
extern CCParameterValue const CCValueTapToMobile; /**< @memberof CCParameters Parameter value indicating a transaction is to be performed via a Tap To Mobile POI. */
...
extern CCParameterValue const CCValueCheque; /**< @memberof CCParameters Parameter value indicating that the transaction will be processed as cheque transaction. */
...
extern CCParameterValue const CCValueVoided; /**< @memberof CCParameters Parameter value returned when the state of a transaction is void. */
...
extern CCParameterValue const CCValuePartiallyCommitted; /**< @memberof CCParameters Parameter value returned when the state of a transaction is partially committed. */

extern CCParameterValue const CCValueDelayed; /**< @memberof CCParameters Parameter value returned when the state of a transaction is delayed.*/

extern CCParameterValue const CCValueOfflineFailed; /**< @memberof CCParameters Parameter value to indicate that there is an offline request which has failed to send. */
extern CCParameterValue const CCValueOfflinePending; /**< @memberof CCParameters Parameter value to indicate that there is an offline request pending for the transaction. */
...
extern CCParameterKey const CCParamTapToMobileConfigurationPercentage; /**< @memberof CCParameters Parameter key indicating the percentage of the configuration process for Tap To Mobile. Value is an integer between 0 and 100. */
...
extern CCParameterKey const CCParamApplyFirmwareUpdate; /** @memberof CCParameters Parameter key indicating if a firmware update is to be performed if one is available. Values can be {@link CCParameters#CCValueTrue TRUE} to update firmware during this connect and configure or {@link CCParameters#CCValueFalse False} to delay. */
...
extern CCParameterKey const CCParamAmount; /**< @memberof CCParameters Parameters key for the transaction amount. */
...
extern CCParameterKey const CCParamUserReference; /**< @memberof CCParameters Parameter key for the user reference. User reference must be unique per transaction. */
...
extern CCParameterKey const CCParamOperatorPin; /**< @memberof CCParameters Parameter key for the operator pin.  */
...
extern CCParameterKey const CCParamBillingAddress1; /**< @memberof CCParameters Parameter key for Address Line One in Billing Information. */
extern CCParameterKey const CCParamBillingAddress2; /**< @memberof CCParameters Parameter key for Address Line Two in Billing Information. */
extern CCParameterKey const CCParamBillingCity; /**< @memberof CCParameters Parameter key for the City in Billing Information. */
extern CCParameterKey const CCParamBillingState; /**< @memberof CCParameters Parameter key for the State in Billing Information */
extern CCParameterKey const CCParamBillingZipCode; /**< @memberof CCParameters Parameter key for the Zip Code in Billing Information. Can be used interchangeably with BILLING_ZIP_CODE */
extern CCParameterKey const CCParamBillingPostalCode; /**< @memberof CCParameters Parameter key for the Zip Code in Billing Information. Can be used interchangeably with BILLING_POSTAL_CODE */
extern CCParameterKey const CCParamBillingCountry; /**< @memberof CCParameters Parameter key for the Country in Billing Information. */
extern CCParameterKey const CCParamBillingEmailAddress; /**< @memberof CCParameters Parameter key for the Email Address in Billing Information. */
extern CCParameterKey const CCParamBillingPhoneNumber; /**< @memberof CCParameters Parameter key for the Phone Number in Billing Information. */

extern CCParameterKey const CCParamPurchaseOrderNumber; /**< @memberof CCParameters Parameter key for the Purchase Order Number. */
extern CCParameterKey const CCParamTaxAmount; /**< @memberof CCParameters Parameter key for the Tax Amount. */
...
extern CCParameterKey const CCParamTransactionState; /**< @memberof CCParameters Parameter key for transaction state. Value can be {@link CCParameters#CCValueCommitted COMMITTED}, {@link CCParameters#CCValueUncommitted UNCOMMITTED}, {@link CCParameters#CCValueVoided VOID} or {@link CCParameters#CCValueUncommittedVoid UNCOMMITTED_VOID}. */
...
extern CCParameterKey const CCParamMaskedPan; /**< @memberof CCParameters Parameter key for a masked PAN. */
extern CCParameterKey const CCParamPar; /**< @memberof CCParameters Parameter key for a PAR. */
...
extern CCParameterKey const CCParamCardHashCollection; /**< @memberof CCParameters Parameter key for the card hash in XML format. Value can be converted to a {@link CCCardHash} object using {@link ChipDnaMobileSerializer#deserializeCardHash:}.*/
...
extern CCParameterKey const CCParamAcquirerResponseCode; /**< @memberof CCParameters Parameter key for the acquirer response code. */
extern CCParameterKey const CCParamDateTimeFormat; /**< @memberof CCParameters Parameter key for the format of the date/times returned. */
...
extern CCParameterKey const CCParamTransactionUpdate; /**< @memberof CCParameters Parameter key for {@link TransactionUpdate} returned; */
extern CCParameterKey const CCParamUserNotification; /**< @memberof CCParameters Parameter key for {@link UserNotification} returned; */
...
extern CCParameterKey const CCParamDigitalSignatureSupported; /**< @memberof CCParameters Parameter key indicating if digital signature is supported. Value can be either {@link CCParameters#CCValueTrue TRUE} or {@link CCParameters#CCValueFalse FALSE}. If not supplied, value is {@link CCParameters#CCValueFalse FALSE}.*/
...
extern CCParameterKey const CCParamSendEmailReceipt; /**< @memberof CCParameters Parameter key for requesting that a receipt should be sent via email. */
extern CCParameterKey const CCParamSendSmsReceipt; /**< @memberof CCParameters Parameter key for requesting that a receipt should be send via SMS. */
...
extern CCParameterKey const CCParamReceiptSourceName; /**< @memberof CCParameters Parameter key for the receipts source name. */
...
extern CCParameterKey const CCParamReceiptEmailSubject; /**< @memberof CCParameters Parameter key for the emails subject field of receipts. */
...
extern CCParameterKey const CCParamCloseTransaction; /**< @memberof CCParameters Parameter key indicating whether a transaction should be closed. */
...
extern CCParameterKey const CCParamOfflineCompletionDateTime; /**< @memberof CCParameters Parameter for the date and time that an offline request was completed. */

extern CCParameterKey const CCParamOfflineRequestErrors; /**< @memberof CCParameters Parameter for the errors associated with an offline request. */

extern CCParameterKey const CCParamAvailableCardApplications; /**< @memberof CCParameters Parameter for the card applications XML to be presented to the Cardholder during application selection. The data converted using {@link ChipDnaMobileSerializer#deserializedAvailableCardApplications:}*/

extern CCParameterKey const CCParamSelectedCardApplication; /**< @memberof CCParameters Parameter for the card application selected by the Cardholder during application selection. */

extern CCParameterKey const CCParamPANKeyEntry; /**< @memberof CCParameters Parameter key for PAN key entry. Value can be either {@link CCParameters#CCValueTrue TRUE} or {@link CCParameters#CCValueFalse FALSE}. */
extern CCParameterKey const CCParamAutoConfirm; /**< @memberof CCParameters Parameter key to trigger auto confirmation of a transaction. Value can be either {@link CCParameters#CCValueTrue TRUE} or {@link CCParameters#CCValueFalse FALSE}.*/
extern CCParameterKey const CCParamTransactionPOI; /**< @memberof CCParameters Parameter key to set the point of interaction to be used for a transaction. Value can be either {@link CCParameters#CCValuePaymentDevice PAYMENT_DEVICE} or {@link CCParameters#CCValueTapToMobile TAP_TO_MOBILE}.*/

extern CCParameterKey const CCParamMerchantData; /**< @memberof CCParameters Parameter key for the merchant data.*/
extern CCParameterKey const CCParamMerchantDisplayName; /**< @memberof CCParameters Parameter key for configured merchant display name. The default name displayed on the PIN pad when it is idle. */
extern CCParameterKey const CCParamMerchantName; /**< @memberof CCParameters Parameter key for the merchant name*/

extern CCParameterKey const CCParamDelayOnlineProcessing; /**< @memberof CCParameters Parameter key to set a transaction as delayed online processing. Value can be either {@link CCParameters#CCValueTrue TRUE} or {@link CCParameters#CCValueFalse FALSE}. */
extern CCParameterKey const CCParamEncodedRequest; /**< @memberof CCParameters Parameter key for the encoded request*/

extern CCParameterKey const CCParamBLEScanTime; /**< @memberof CCParameters Parameter key for configuring the length of time Bluetooth Low Energy (BLE) devices will be scanned for. The value is required to be a string valued number between 1 and 30. The default value of 5 seconds will be used if this value is not passed into {@link availablePinPadsRequest} and {@link connectAndConfigure}.*/

extern CCParameterKey const CCParamCredentialOnFileFirstStore; /**< @memberof CCParameters Parameter key to indicate the transaction is the first store for a Credential on File transaction. */
extern CCParameterKey const CCParamCredentialOnFileReason; /**< @memberof CCParameters Parameter key for Credential on File transactions to indicate the reason for the transaction. Values can be {@link CCParameters#CCValueReasonUnscheduled UNSCHEDULED}, {@link CCParameters#CCValueReasonInstallment INSTALLMENT}, {@link CCParameters#CCValueReasonIncremental INCREMENTAL}, {@link CCParameters#CCValueReasonResubmission RESUBMISSION}, {@link CCParameters#CCValueReasonDelayedCharge DELAYED_CHARGE}, {@link CCParameters#CCValueReasonReAuth RE_AUTH} or {@link CCParameters#CCValueReasonNoShow NO_SHOW}. */
extern CCParameterKey const CCParamFirmwareUpdateAvailable; /**< @memberof CCParameters Parameter key indicating if a firmware update is available. Value can be either {@link CCParameters#CCValueTrue TRUE} or {@link CCParameters#CCValueFalse FALSE}. */
extern CCParameterKey const CCParamFirmwareUpdateStatus; /**< @memberof CCParameters Parameter key for current firmare update status XML string. XML can be converted into an {@link FirmwareUpdateStatus} object using {@link ChipDnaMobileSerializer#deserializeFirmwareUpdateStatus}. */
extern CCParameterKey const CCParamFirmwareDownloadPercentage; /**< @memberof CCParameters Parameter key indicating the percentage of firmware downloaded to the device. Value is an integer between 0 and 100. */
extern CCParameterKey const CCParamFirmwareFile; /**< @memberof CCParameters Parameter key indicating the name of the firmware file being downloaded to the device. */
extern CCParameterKey const CCParamFirmwareUpdate; /**< @memberof CCParameters Parameter key for {@link FirmwareUpdate} returned. */
extern CCParameterKey const CCParamAddressVerificationResult; /**< @memberof CCParameters Parameter key for the address verification result. Value can be Matched, NotChecked, NotMatched, NotSupplied or PartialMatch. */
extern CCParameterKey const CCParamZipCodeVerificationResult; /**< @memberof CCParameters Parameter key for the zip code verification result. Value can be Matched, NotChecked, NotMatched, NotSupplied or PartialMatch. */
extern CCParameterKey const CCParamCscVerificationResult; /**< @memberof CCParameters Parameter key for the CSC verification result. Value can be Matched, NotChecked, NotMatched, NotSupplied or PartialMatch. */
extern CCParameterKey const CCParamPaymentDevicePOI; /**< @memberof CCParameters Parameter key to set if the Payment Device point of interaction is to be configured for payment processing.*/
extern CCParameterKey const CCParamTapToMobilePOI; /**< @memberof CCParameters Parameter key to set if the Tap To Mobile point of interaction is to be configured for payment processing.*/
extern CCParameterKey const CCParamPOSGUID; /**< @memberof CCParameters Parameter key for the current Point of Sale Globally Unique Identifier.*/
extern CCParameterKey const CCParamTapToMobilePOIIdentifier; /**< @memberof CCParameters Parameter key for the current TTM Point of Interaction Identifier.*/
/**
 * @}
 */
