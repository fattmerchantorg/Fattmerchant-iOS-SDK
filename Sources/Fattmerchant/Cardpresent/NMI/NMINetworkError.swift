...
/// Represents errors that can occur during NMI API network operations.
///
...
public enum NMINetworkError: OmniException {
  public static var mess = "NMI Network Error"
  public var detail: String? {
    switch self {
      ...
      case .apiError(let message): return "NMI API Error: \(message)"
    }
  }
  ...
  /// An API-level error returned by NMI.
  /// - Parameter String: The error message from the NMI API response.
