...
/// A type-safe representation of an HTTP request to the NMI API.
/// The generic parameter `Response` defines the expected response type that will be decoded.
///
/// Example usage:
/// ```
/// let request = NMIApiRequest<NMIProcessor>(
///     path: "/v4/processors",
///     method: .post
/// )
/// ```
struct NMIApiRequest<Response: Decodable> {
  /// The path component of the URL, relative to the base URL.
  /// Should start with a forward slash, e.g. "/v4/processors".
  let path: String
  
  /// The HTTP method to use for the request.
  let method: NMIHttpMethod
