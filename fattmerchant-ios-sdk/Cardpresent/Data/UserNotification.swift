...
public struct UserNotification {
    ...
    private static let userNotifcationValue = "Prompt User Error Application Not Supported"

    private static let userNotificationFriendlyMsg = "There was an error with processing the chip card. Please try again."
    ...
    public static let ChipReadErrorApplicationNotSupportedPleaseRetry = UserNotification(userNotifcationValue, userNotificationFriendlyMsg)
